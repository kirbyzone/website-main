<form hx-post="<?=site()->url()?>/subscribe" hx-target="#subscribe" class="flex flex-col space-y-2 mt-2" >
  ...
  <button type="submit" class="bg-cream/80 text-wine text-2xl font-cursive py-3 px-10 rounded-lg w-36 transition-all duration-300 hover:bg-cream">sign up</button>
</form>
